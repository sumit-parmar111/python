...
class HomeScreen(QMainWindow):
    ...
    def refreshHome(self):
        ...
        for data in alldata:
            ...
            if data[3]==1:
                label.setStyleSheet("background-color:green;color:white;padding:5px;width:300px;height:300px;border:1px solid white;text-align:center;font-weight:bold")
            else:
                label.setStyleSheet("background-color:red;color:white;padding:5px;width:300px;height:300px;border:1px solid white;text-align:center;font-weight:bold")
